	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		sendEmail.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				try
				{
					ArrayList<Uri> filePaths = GraphActivity.getFilePaths();
					Intent sendIntent = new Intent(Intent.ACTION_SEND_MULTIPLE);
					sendIntent.setType("message/rfc822");
					sendIntent.putExtra(Intent.EXTRA_SUBJECT, "ArduinoGUI Data");
					...
					sendIntent.putParcelableArrayListExtra(Intent.EXTRA_STREAM, filePaths);
					startActivity(Intent.createChooser(sendIntent, "Send E-Mail Using..."));
				}
				catch(NullPointerException e)
				{
					Toast.makeText(getApplicationContext(), "No Files to Send", Toast.LENGTH_SHORT).show();
				}
			}
		});
	}
