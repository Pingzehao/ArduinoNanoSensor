...
public class OptionsActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mBaselinePeriod = (EditText) findViewById(R.id.baselinePeriod);
		...
		mStartPolling.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				...
				if (!GraphActivity.isPolling())
				{
					try
					{
						mBaselineDuration = Integer.parseInt(mBaselinePeriod.getText().toString());
					}
					catch(NumberFormatException n)
					{
						Log.e(LOG, "edu.ucr.arduinoioio::OptionsActivity.java::onClick(View v) - Error parsing baseline duration");
					}
					...
					GraphActivity.startPolling(mPinsChecked, mPollingRate, mBaselineDuration, serverIP, serverPort);
				}
				else
				{
