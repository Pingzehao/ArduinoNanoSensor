...
public class SensorServerGUI16 extends WindowAdapter
{
	...
	/** JFrame for applet */
	private static JFrame mFrame = new JFrame("SensorServerGUI - 16 Sensors");
	...
	private static void initializeGUI()
	{
		...
		JCheckBoxMenuItem menuItem5 = new JCheckBoxMenuItem("Sensor 5");
		menuItem5.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(4, mMenuItems.get(4).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem6 = new JCheckBoxMenuItem("Sensor 6");
		menuItem6.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(5, mMenuItems.get(5).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem7 = new JCheckBoxMenuItem("Sensor 7");
		menuItem7.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(6, mMenuItems.get(6).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem8 = new JCheckBoxMenuItem("Sensor 8");
		menuItem8.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(7, mMenuItems.get(7).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem9 = new JCheckBoxMenuItem("Sensor 9");
		menuItem9.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(8, mMenuItems.get(8).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem10 = new JCheckBoxMenuItem("Sensor 10");
		menuItem10.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(9, mMenuItems.get(9).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem11 = new JCheckBoxMenuItem("Sensor 11");
		menuItem11.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(10, mMenuItems.get(10).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem12 = new JCheckBoxMenuItem("Sensor 12");
		menuItem12.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(11, mMenuItems.get(11).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem13 = new JCheckBoxMenuItem("Sensor 13");
		menuItem13.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(12, mMenuItems.get(12).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem14 = new JCheckBoxMenuItem("Sensor 14");
		menuItem14.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(13, mMenuItems.get(13).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem15 = new JCheckBoxMenuItem("Sensor 15");
		menuItem15.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(14, mMenuItems.get(14).isSelected());
			}
		});
		JCheckBoxMenuItem menuItem16 = new JCheckBoxMenuItem("Sensor 16");
		menuItem16.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent event)
			{
				setPin(15, mMenuItems.get(15).isSelected());
			}
		});
		
		JMenuItem menuItemShowAll = new JMenuItem("Show All");
		...
		JMenuItem menuItemHideAll = new JMenuItem("Hide All");
		menuItemHideAll.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event)
			{
				for(int i = 0; i < CHIP_PINS; ++i)
				{
					mMenuItems.get(i).setSelected(false);
					setPin(i, false);
				}
			}
		});
		...
		mMenuItems.add(menuItem10);
		mMenuItems.add(menuItem11);
		mMenuItems.add(menuItem12);
		mMenuItems.add(menuItem13);
		mMenuItems.add(menuItem14);
		mMenuItems.add(menuItem15);
		mMenuItems.add(menuItem16);
		...
		mMenu.add(menuItem8);
		mMenu.add(menuItem9);
		mMenu.add(menuItem10);
		mMenu.add(menuItem11);
		mMenu.add(menuItem12);
		mMenu.add(menuItem13);
		mMenu.add(menuItem14);
		mMenu.add(menuItem15);
		mMenu.add(menuItem16);
		mMenu.add(menuItemShowAll);
		mMenu.add(menuItemHideAll);
