...
public class GraphView extends SurfaceView implements SurfaceHolder.Callback
{
	...
	public void writeChipData(ArrayList<ArrayList<Data>> dataToWrite)
	{
		...
		for(int i = 0; i < CHIP_PINS; ++i)
		{
			...
			{
				Log.e(LOG, "at edu.ucr.arduinoioio::GraphView.java::writeChipData(ArrayList<ArrayList<Data>> dataToWrite) - Error writing Chip Data to File ");
				e.printStackTrace();
			}
		}
	}
	...
	public void writeMQ2Data(ArrayList<Data> dataToWrite)
	{
		...
		{
			Log.e(LOG, "at edu.ucr.arduinoioio::GraphView.java::writeMQ2Data(ArrayList<Data> dataToWrite) - Error writing MQ2 Data to File");
			e.printStackTrace();
		}
	}
	...
	public void writeHumidityData(ArrayList<Data> dataToWrite, ArrayList<Data> temperatureData)
	{
		...
		{
			Log.e(LOG, "at edu.ucr.arduinoioio::GraphView.java::writeHumidityData(ArrayList<Data> dataToWrite, ArrayList<Data>) temperatureData - Error writing Humidity Data to File ");
			e.printStackTrace();
		}
	}
	...
	public void writeTempData(ArrayList<Data> dataToWrite)
	{
		...
		{
			Log.e(LOG, "at edu.ucr.arduinoioio::GraphView.java::writeTempData(ArrayList<Data> dataToWrite) - Error writing Temperature Data to File ");
			e.printStackTrace();
		}
	}
	 ...
	 * @param timeStarted
	 */
	public void addData(final int[] values, Calendar timeStarted)
	{
		for(int i = 0; i < ANALOG_PINS; ++i)
		{
	...
	/**
	 * Saves the values for the digital potentiometer. Used to calculate sensor chip resistance based on the voltage. Resistances are initially matched to the same as the sensor.
	 * 
	 * @param dataToAdd
	 */
	public void setDividerResistances(final int[] dividerResistances)
	{
		for(int i = 0; i < CHIP_PINS; ++i)
		{
