...
public class GraphActivity extends Activity
{
				...
				while(true)
				{
					if(mSerialService.isPolling())
					{
						...
						if(dataToAdd != null && dataToAdd[0] != -1 && dataToAdd[7] != -1)
						{
							...
							/** Resets all the values to -1 so the same value doesn't get added twice */
	...
	public static void startPolling(boolean[] pinsChecked, String output, int pollingRate, String email, double percentThreshold)
	{
