...
public class OptionsActivity extends Activity
{
	...
	private EditText autoEmail;
	private EditText thresholdPercentage;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		autoEmail = (EditText) findViewById(R.id.autoEmail);
		thresholdPercentage = (EditText) findViewById(R.id.thresholdPercentage);
		...
		setWindow.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				...
				try
				{
					min = Integer.parseInt(windowMin.getText().toString());
				}
				...
				try
				{
					max = Integer.parseInt(windowMax.getText().toString());
				}
				catch(NumberFormatException e)
				{
		...
		startPolling.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				if(GraphActivity.mSerialService.getState() == BluetoothSerialService.STATE_NONE)
				{
				...
				if(!startedPolling)
				{
					...
					try
					{
						pollingRate = Integer.parseInt(prValue.getText().toString());
					...
					try
					{
						percentThreshold = Double.parseDouble(thresholdPercentage.getText().toString());
					}
					catch(NumberFormatException n)
					{
						Log.e("ArduinoGUI", "ERROR PARSiNG THRESHOLD");
					}
					GraphActivity.startPolling(pinsChecked, output, pollingRate, email, percentThreshold);
				}
				else
				{
