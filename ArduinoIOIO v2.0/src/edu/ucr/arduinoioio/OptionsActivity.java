...
public class OptionsActivity extends Activity
{
	...
	private int mPollingRate = GraphActivity.MIN_POLLING_RATE + 100;
			...
			public void onClick(View v)
			{
				...
				if (!GraphActivity.isPolling())
				{
					...
					try
					{
						...
						if(mPollingRate < GraphActivity.MIN_POLLING_RATE + 100)
							mPollingRate = GraphActivity.MIN_POLLING_RATE + 100;
					}
