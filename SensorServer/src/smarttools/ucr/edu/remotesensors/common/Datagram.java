...
public class Datagram {
	...
	public static Datagram processLine(String line){
		...
		try{
			...
			int d1 = Integer.parseInt(split[2].trim());
			int d2 = Integer.parseInt(split[3].trim());
			int d3 = Integer.parseInt(split[4].trim());
			int d4 = Integer.parseInt(split[5].trim());
			int d5 = Integer.parseInt(split[6].trim());
			int d6 = Integer.parseInt(split[7].trim());
			int d7 = Integer.parseInt(split[8].trim());
			double latitude = Double.parseDouble(split[9].trim());
			double longitude = Double.parseDouble(split[10].trim());
