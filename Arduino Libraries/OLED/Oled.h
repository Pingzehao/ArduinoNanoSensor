...
#define OLED_SET_MEM_ADDRESS	0X41
#define OLED_WRITE_BYTE			0x77
#define BLK_0					0x00
...
class OLED
{
  ...
  public:
	...
	uint8_t DrawRectangle(uint8_t x, uint8_t y, uint8_t x2, uint8_t y2, unsigned int color);
	uint8_t DrawCircle(uint8_t x, uint8_t y, uint8_t radius, unsigned int color);
	uint8_t SetFontSize(uint8_t FontType);
	uint8_t DrawText(uint8_t column, uint8_t row, uint8_t font_size, char mychar, unsigned int color);
	uint8_t DrawText(uint8_t column, uint8_t row, uint8_t font_size, char *mytext, unsigned int color);
	uint8_t DrawText(uint8_t column, uint8_t row, uint8_t font_size, int myint, unsigned int color);
	uint8_t DrawText(uint8_t column, uint8_t row, uint8_t font_size, long mylong, unsigned int color);
	uint8_t DrawText(uint8_t column, uint8_t row, uint8_t font_size, double mydouble, unsigned int color);
	...
	uint8_t SetSDAddress(uint8_t bit1, uint8_t bit2, uint8_t bit3, uint8_t bit4);
	void writeSDByte(char c);
	void writeSDString(String s);
